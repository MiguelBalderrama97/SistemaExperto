...
resource(pregunta,image,image('pregunta.jpg')).
resource(javascript,image,image('javascript.jpg')).
resource(c_sharp,image,image('c_sharp.jpg')).
resource(c,image,image('c.jpg')).
resource(c_plus,image,image('c++.jpg')).
resource(java,image,image('java.jpg')).
resource(kotlin,image,image('kotlin.jpg')).
resource(objetive,image,image('objetive.jpg')).
resource(php,image,image('php.jpg')).
resource(swift,image,image('swift.jpg')).
resource(ruby,image,image('ruby.jpg')).
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
  botones:-borrado,
                ...
                send(@texto, selection('Tu lenguaje de programacion es:')),
...
tratamiento(X):- send(@lblExp1,selection('Debes usar este lenguaje de programacion')),
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  interfaz_principal:-new(@main,dialog('QUE LENGUAJE DE PROG ELEGIR',
        size(1000,1000))),
